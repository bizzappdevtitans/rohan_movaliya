...
class SchoolStudent(models.Model):
    ...
    last_date = fields.Date(string="Last date", compute="_compute_last_date")
    ...
    count_teacher = fields.Integer(
        string="Count teacher", compute="_compute_count_teacher"
    )
    count_subject = fields.Integer(
        string="Count subject", compute="_compute_count_subject"
    )
    ...
    total_girls = fields.Integer(string="Total girls")
